...
class Transaction(Base):
    ...
    # create properties of the class type of transaction  that determines whether it's a credit or a debit
    transaction_type = Column(Enum(TransactionStatus))
    # create properties of the class amount transaction
    transaction_amount = Column(Float)
    # create properties of the class date and time
    transaction_date_time = Column(DateTime)
    # create properties of the class sender / receiver
